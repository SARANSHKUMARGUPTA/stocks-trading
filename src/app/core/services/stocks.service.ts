...
import { StocksModel, StockDetail, StockNameSymbol } from './stocks.model';
...
export class StocksService {
  ...
  private gainersUrl = 'https://cloud.iexapis.com/stable/stock/market/list/gainers?token=pk_87c0cd9af5cb4d988cecee052ac9b5fa';  // URL to web api
  private loserssUrl = 'https://cloud.iexapis.com/stable/stock/market/list/losers?token=pk_87c0cd9af5cb4d988cecee052ac9b5fa';  // URL to web api
  ...
  public getDetails (symbol: string): Observable<StockDetail> {
    return this.http.get<StockDetail>(this.stockNewsUrl + symbol + '/' +  this.stocksEndPoint + '&token=pk_87c0cd9af5cb4d988cecee052ac9b5fa');
     /* .pipe(
  ...
  public getSymbols (symbol: string): Observable<any> {
    return this.http.get<any>(this.stockNewsUrl + symbol + '/' +  this.stocksEndPoint + '&token=pk_87c0cd9af5cb4d988cecee052ac9b5fa' );
  }
